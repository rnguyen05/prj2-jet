$(document).ready(function() {
  ...
  var usernameInput = $("input#username-input-registration");
  var emailInput = $("input#email-input-registration");
  var passwordInput = $("input#password-input-registration");

  var repeatPasswordInput = $("input#repeat-password-input-registration");
  var repeatEmailInput = $("input#repeat-email-input-registration");
